  ...
  return (
    <footer className="bg-black text-white pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mt-20 mb-10 text-sm text-center">Проводится в рамках реализации программы мероприятий по гранту АНО «Аналитический центр при Правительстве Российской Федерации» по договору Nº 70-2025-000814 от 04.06.2025 о реализации программ топ-уровня в сфере информационных технологий.</div>
      </div>
    </footer>
  );
};
